<div class="bg-gray-100">
    <h2 class="text-2xl md:text-4xl text-gray-600 text-center font-extrabold ">Buscar Lideres</h2>
    <div class="max-w-7xl mx-auto">
        <form wire:submit.prevent="buscar">
            <div class="md:flex md:justify-center md:items-center mb-5">
                <div class="md:w-1/2">
                    <div>
                        <label class="block mb-1 text-sm text-gray-700 uppercase font-bold " for="termino"> Lider
                        </label>
